		...
		<div class="atraction-new-form" style="width: 100%; display: inline-block; overflow: hidden;"> 
			...
			<div class="atraction-main-information-and-map" style="float:left; margin-top:-1.5rem">
				...
				<div class="atraction-main-information">
					...
					<div class="alert fade in atraction-alert" id="mensajeDescripcionVacia" style="display: none;">
					 	<a class="close" data-dismiss="alert" aria-label="close"></a>
				...
				<div class="atraction-blueprints-group">
					...
					<div id="blueprints" style="display: none;style="float:left"">
						...
						<div class="atraction-blueprints-alert-messages">
							...
							<div class="alert fade in atraction-alert" id="mensajePlanoIncorrectoError" style="display: none;">
							 	<a class="close" data-dismiss="alert" aria-label="close"></a>
					...
					<div class="alert fade in atraction-alert" id="mensajeHayVideo" style="display: none;float:left">
					 	<a class="close" data-dismiss="alert" aria-label="close"></a>
					 	<strong>&iexclError!</strong> Ya se ha seleccionado un video anteriormente! Solo se puede seleccionar uno!
					</div>
					
					<div class="alert fade in atraction-alert" id="mensajeCincoArchivos" style="display: none;float:left">
					 	<a class="close" data-dismiss="alert" aria-label="close"></a>
					 	<strong>&iexclError!</strong> Ya se han seleccionado 5 archivos, no se pueden agregar mas!
					</div>
					
					<div class="alert fade in atraction-alert" id="mensajeTamanoImagen" style="display: none;float:left">
					 	<a class="close" data-dismiss="alert" aria-label="close"></a>
					 	<strong>&iexclError!</strong> La imagen no puede pesar mas de 50KB!
					</div>
					
					<div class="alert fade in atraction-alert" id="mensajeTamanoVideo" style="display: none;float:left">
					 	<a class="close" data-dismiss="alert" aria-label="close"></a>
					 	<strong>&iexclError!</strong> El video no puede pesar mas de 10MB!
					</div>
					
					<div class="alert fade in atraction-alert" id="mensajeUnaImagen" style="display: none;float:left">
					 	<a class="close" data-dismiss="alert" aria-label="close"></a>
			...
			<div class="atraction-right-block">
				...
				<div style="float: right">
					...
					<div class="alert fade in new-atraction-alert-no-location" id="mensajeUbicacionVacia" style="display: none">
					 	<a class="close" data-dismiss="alert" aria-label="close"></a>
				...
				<div class="alert fade in atraction-alert-point-of-interest-needed" id="mensajePuntoDeInteresNecesario" style="display: none; clear: right; float: right; margin-right: 5rem;">
				 	<a class="close" data-dismiss="alert" aria-label="close"></a>
