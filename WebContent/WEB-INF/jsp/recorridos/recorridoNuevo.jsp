...
<body>
	...
	<div id="routeForm" style="width: 94%; margin-left: 3%; margin-right: 3%">
		...
		<div class="route_new_form" style="display: inline-block; overflow: hidden;">
			...
			<div class="route_right_block" style="float: right">
				...
				<div id="route_map_group">
					...
					<div class="alert fade in error_msg_new_route_no_atraction" id="mensajeNingunaAtraccionElegida" style="display: none">
					 	<a class="close" data-dismiss="alert" aria-label="close"></a>
		...
		<div class="alert fade in error_msg_route_already_exists" id="mensajeNombreRepetido" style="display: none;">
		 	<a class="close" data-dismiss="alert" aria-label="close"></a>
